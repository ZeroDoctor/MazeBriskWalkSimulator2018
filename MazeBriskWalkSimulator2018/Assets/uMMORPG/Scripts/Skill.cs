...
public partial struct Skill
{
    ...
    public float CastTimeRemaining()
    {
        ...
        return (float) NetworkTime.time >= castTimeEnd ? 0 : (float)(castTimeEnd - NetworkTime.time);
    }
    ...
    public float CooldownRemaining()
    {
        ...
        return (float) NetworkTime.time >= cooldownEnd ? 0 : (float)(cooldownEnd - NetworkTime.time);
    }
